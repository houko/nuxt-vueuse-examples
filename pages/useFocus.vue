...
<template>
  <div>
    ...
    />
    <el-button ref="button" class="demo-el button">
      Button that can be focused
    </el-button>
    <hr />
    <note class="mb-2">
      <template v-if="paragraphFocus"> The paragraph has focus </template>
      <template v-else-if="inputFocus"> The input control has focus </template>
      <template v-else-if="buttonFocus"> The button has focus </template>
      <template v-else>
    ...
    <el-button
      class="button small"
      :class="{ orange: inputFocus }"
      @click="inputFocus = !inputFocus"
    >
      Focus input
    </el-button>
    <el-button
      class="button small"
      :class="{ orange: buttonFocus }"
      @click="buttonFocus = !buttonFocus"
    >
      Focus button
    </el-button>
  </div>
